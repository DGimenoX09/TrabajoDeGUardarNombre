...
public class SaveManager : MonoBehaviour
{
    ...
    void LoadData()
    {
        ...
        positionText.text = "Player Position " + PlayerPrefs.GetFloat("posX", 0).ToString() + "x " + PlayerPrefs.GetFloat("posY", 0).ToString() + "y " + PlayerPrefs.GetFloat("posZ", 0).ToString() + "z"; 
